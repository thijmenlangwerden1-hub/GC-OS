...
class SchoolOS(ctk.CTk):
    ...
    def show_dashboard(self):
        ...
        ctk.CTkButton(btn_f, text="Magister", fg_color=t["button_fg"], text_color=t["button_text"], hover_color=t["button_hover"], command=lambda: webbrowser.open("https://gc.magister.net/magister/#/vandaag")).pack(side="left", padx=4, pady=5, expand=True, fill="x")

        ctk.CTkButton(btn_f, text="Itslearning", fg_color=t["button_fg"], text_color=t["button_text"], hover_color=t["button_hover"], command=lambda: webbrowser.open("https://graafschapcollege.itslearning.com/CourseCards")).pack(side="left", padx=4, pady=5, expand=True, fill="x")
