...
class UpdateWindow(ctk.CTkToplevel):
    ...
    def __init__(self, parent):
        ...
        card = ctk.CTkFrame(self, fg_color="#0E131C", corner_radius=30, border_width=1, border_color="#1B2636")
        card.pack(fill="both", expand=True, padx=26, pady=26)
        ctk.CTkLabel(card, text="↻", font=ctk.CTkFont(size=34, weight="bold"), text_color=t["accent"], fg_color="#121B2B", corner_radius=18, width=68, height=68).pack(pady=(30, 12))
        ctk.CTkLabel(card, text="UPDATE CENTER", font=ctk.CTkFont(size=27, weight="bold"), text_color=t["text"]).pack()
