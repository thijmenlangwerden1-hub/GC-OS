...
class SchoolOS(ctk.CTk):
    ...
    def show_rooster(self):
        ...
        # NIEUW: Vandaag-knop om direct terug te keren naar de huidige dag/week/maand
    ...
    def rooster_vandaag(self):
        """Springt direct terug naar de actuele datum van vandaag."""
        self.huidige_rooster_datum = dt.date.today()
        self.show_rooster()

    # Opmerking: Zorg dat je de overige functies zoals render_week_rooster(), render_maand_rooster(),
    # show_notities(), show_cijfers() en show_settings() onder deze klasse behoudt.
